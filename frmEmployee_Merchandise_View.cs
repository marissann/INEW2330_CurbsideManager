...
{
    public partial class frmEmployee_Merchandise_View : Form
    {
        //Set up merchandise CurrencyManager
        CurrencyManager merchManager;

        //Variables for state and bookmark
        string myState = "";
        int myBookmark = 0;

        public frmEmployee_Merchandise_View()
        {
            InitializeComponent();
        }

        private void frmEmployee_Merchandise_View_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void frmEmployee_Merchandise_View_FormClosing(object sender, FormClosingEventArgs e)
        {
